...
CREATE OR REPLACE FUNCTION C##PLSQL_T.calculate_bonus(p_salary NUMBER, p_department VARCHAR2)
RETURN NUMBER
AS
  l_bonus NUMBER;
BEGIN
...
CREATE OR REPLACE PROCEDURE C##PLSQL_T.test_calculate_bonus
AS
  -- Test variables
  l_result NUMBER;
  l_expected NUMBER;
...
BEGIN
  ...
  l_result := C##PLSQL_T.calculate_bonus(60000, 'Engineering');
  ...
  l_result := C##PLSQL_T.calculate_bonus(40000, 'Engineering');
